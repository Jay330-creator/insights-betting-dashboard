import type { Pick, Result, BetType, League, ConfidenceTier } from '../data/sample';
...
export function byConfidenceTier(picks: Pick[]) {
  return groupBy(picks, p => (p.confidenceTier || 'unknown') as ConfidenceTier);
}
